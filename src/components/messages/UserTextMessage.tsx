...
type UserTextChildMessage = React.ComponentType<{
  addMargin: boolean;
  param: TextBlockParam;
}>;
...
export function UserTextMessage({
  ...
  if (feature('KAIROS_GITHUB_WEBHOOKS')) {
    if (param.text.startsWith('<github-webhook-activity>')) {
      ...
      const Component = UserGitHubWebhookMessage as UserTextChildMessage;
      return React.createElement(Component, { addMargin, param });
    }
  }
  ...
  if (feature('FORK_SUBAGENT')) {
    if (param.text.includes('<fork-boilerplate>')) {
      ...
      /* eslint-enable @typescript-eslint/no-require-imports */
      const Component = UserForkBoilerplateMessage as UserTextChildMessage;
      return React.createElement(Component, { addMargin, param });
    }
  }
  ...
  if (feature('UDS_INBOX')) {
    if (param.text.includes('<cross-session-message')) {
      ...
      /* eslint-enable @typescript-eslint/no-require-imports */
      const Component = UserCrossSessionMessage as UserTextChildMessage;
      return React.createElement(Component, { addMargin, param });
    }
  }
