...
> 基于 [CCB (claude-code-best)](https://github.com/James-FE/claude-code-best) v2.1.888 逆向工程版。
...
```bash
git clone https://github.com/James-FE/CC_Pure
cd CC_Pure
bun install
bun run build
...
- **上游**: [James-FE/claude-code-best](https://github.com/James-FE/claude-code-best) (CCB)
- **分叉点**: `562e9daa`
